            ...
            {showOptions.show && (
              <section className="d-block mt-3 color-primary" style={{ maxWidth: "100%" }}>
                <div className="d-flex align-items-center mb-2 text-nowrap">
                  <div>Sort by:</div>
                  <div id="sortForm" className="d-flex overflow-auto ms-2 noScrollBar" style={{ maxWidth: "75vw" }}>
                    <div
                ...
                <div className="d-flex align-items-center mb-2 text-nowrap">
                  <div>Show:</div>
                  <div id="showForm" className="d-flex overflow-auto ms-2 noScrollBar" style={{ maxWidth: "79vw" }}>
                    <div
                      className={`rounded m-1 p-2 pointer`}
                      onClick={(e) => {
